...
larrosaRose :: Label
larrosaRose = Label [garnacha] rioja $ Rose 14
...
lePetitHaitLafitte = Label [cabernetSauvignon, merlot] bordeaux $ Red 13.5
...
containsGrape labels grape = any (elem grape . grapes) labels
